...
class NexusTree:
    ...
    def parse(self):
        return newick.parse(self.newick, ttable=self.ttable)
...
class Nexus(object):
    ...
    def _tree(self,options):
        ...
        newick = newick=opts.rest().strip()
        tree = NexusTree(name=name, weight=weight, rooted=rooted,
                         newick=newick, ttable=self.translate)
        #print "read", newick
